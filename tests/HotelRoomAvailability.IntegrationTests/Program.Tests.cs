...
public class ProgramTests
{
    ...
    [Test]
    public async Task Should_PrintUsage_When_ArgsLengthIsLessThan4()
    {
        // Arrange
    ...
    [Test]
    public async Task Should_PrintError_When_HotelsParamIsMissing()
    {
        // Arrange
    ...
    [Test]
    public async Task Should_PrintError_When_HotelsFileDoesNotExist()
    {
        // Arrange
    ...
    [Test]
    public async Task Should_PrintError_When_BookingsParamIsMissing()
    {
        // Arrange
    ...
    [Test]
    public async Task Should_PrintError_When_BookingsFileDoesNotExist()
    {
        // Arrange
    ...
    public async Task Should_ProcessAvailabilityCommand_Correctly(string availability, string expectedOutput)
    {
        // Arrange
        ...
        // Act
        await RunProgram(["--hotels", "hotels.json", "--bookings", "bookings.json"]);
    ...
    [Test]
    public async Task Should_ProcessSearchCommandAndPrintAvailability_WhenAvailabilityExists()
    {
        // Arrange
    ...
    [Test]
    public async Task Should_ProcessSearchCommandAndReturnsEmptyLine_WhenAvailabilityDoesNotExist()
    {
        // Arrange
